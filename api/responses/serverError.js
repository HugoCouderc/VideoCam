...
module.exports = function serverError (data, options) {
  ...
  // work, just send JSON.
  if (options.view) {
    return res.view(options.view, { data: viewData, title: 'Server Error', user : req.user });
  }

  // If no second argument provided, try to serve the default view,
  // but fall back to sending JSON(P) if any errors occur.
  else return res.view('500', { data: viewData, title: 'Server Error', user : req.user }, function (err, html) {
